<div class="container-fluid gradient-custom5 custom-height d-flex align-items-center px-5">
	<div class="col py-3 px-5 bg-light rounded-4">
		...
		<?php } ?>
		<h4 class="text-center mb-4">Jadwal Sidang</h4>
		<table class="table table-striped table-hover table-bordered">
			...
			<tbody>
				...
				foreach ($sidang as $j) { ?>
					<tr>
						...
						<th class="d-flex justify-content-center">
							<button type="button" class="btn bg-dark text-white mx-1"
								data-bs-target="#editModal<?= $j->id_sidang ?>" data-bs-toggle="modal">Edit</button>
							<button type="button" class="btn btn-warning text-white mx-1"
								data-bs-target="#deleteModal<?= $j->id_sidang ?>" data-bs-toggle="modal">Delete</button>
					...
					<div class="modal hide fade" id="editModal<?= $j->id_sidang ?>" tabindex="-1">
					...
					<div class="modal hide fade" id="deleteModal<?= $j->id_sidang ?>" tabindex="-1">
						<div class="modal-dialog modal-dialog-centered">
							<div class="modal-content">
